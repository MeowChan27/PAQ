...
public enum Wonder {
	...
	Halicarnasse("Halicarnasse", "Halicarnasse", //
			...
			+ "Mélangez-les cartes restantes dans leur pioche","decks/deck-babylon.png", "cards/card-back/card-back-halicarnasse.png",CardDecks.deckCardQuantities_Halicarnasse),

	Ephese("Ephese", "Ephèse", //
			"Prenez la première carte de la pioche centrale et posez-la devant vous","decks/deck-cizeh.png", "cards/card-back/card-back-ephese.png",CardDecks.deckCardQuantities_Ephese),
	
	Olympie("Olympie", "Olympie", //
			"Prenez la première carte de la pioche à votre gauche et de celle à votre droite, et posez-les devant vous","decks/deck-ephese.png", "cards/card-back/card-back-olympie.png",CardDecks.deckCardQuantities_Olympie),
	
	Babylone("Babylone", "Babylone", //
			"Choisissez 1 jeton Progrès parmi les 4 disponibles, et posez-le devant vous","decks/deck-halicarnasse.png", "cards/card-back/card-back-babylon.png",CardDecks.deckCardQuantities_Babylon),
	
	Rhodes("Rhodes", "Rhodes", //
			"Ajoutez 1 Bouclier à votre total de Boucliers","decks/deck-olympie.png", "cards/card-back/card-back-rhodes.png",CardDecks.deckCardQuantities_Rhodes),

	Gizeh("Gizeh", "Gizeh", //
			"Cette merveille n'a pas d'effet particulier, mais rapporte plus de points de victoire que les autres Merveilles","decks/deck-rhodes.png", "cards/card-back/card-back-gizeh.png",CardDecks.deckCardQuantities_Gizeh);
